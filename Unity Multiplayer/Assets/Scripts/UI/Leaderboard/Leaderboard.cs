...
public class Leaderboard : NetworkBehaviour
{
    ...
    private void HandleLeaderboardEntitiesChanged(NetworkListEvent<LeaderboardEntityState> changeEvent)
    {
        switch (changeEvent.Type)
        {
            case NetworkListEvent<LeaderboardEntityState>.EventType.Add:
                ...
                {
                    LeaderboardEntityDisplay leaderboardEntiry =
                        Instantiate(leaderboardEntityPrefab, leaderboardEntityHolder);

                    leaderboardEntiry.Initialize(
                        changeEvent.Value.ClientId,
                        changeEvent.Value.PlayerName,
                        changeEvent.Value.Coins
                    );

                    entityDisplays.Add(leaderboardEntiry);
                }
                break;
        ...
        LeaderboardEntityDisplay myDisplay = entityDisplays
    ...
    private void HandlePlayerSpawned(TankPlayer player)
    {
        ...
        player.Wallet.TotalCoins.OnValueChanged += (oldCoins, newCoins) =>
            HandleCoinsChange(player.OwnerClientId, newCoins);
    }
